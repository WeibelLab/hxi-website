...
**Teaching**: UCSD Ph.D. students are typically required to teach at least one or two quarters throughout their Ph.D. (different departments have different rules). The HXI lab offers a number of classes across Computer Science and Design, and Ph.D. students will be regularly involved in these activities. Beyond any departmental requirement, Ph.D. students in the HXI Lab are expected to serve as Teaching Assistant for <b>one class per academic year</b>, assigned among the [courses taught by the lab](/teaching/).
